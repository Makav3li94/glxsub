...
import { Bundle, Pair, PairDayData, Token, TokenDayData, GLXSwapDayData, GLXSwapFactory } from '../types/schema'
import { PairHourData } from './../types/schema'
import { FACTORY_ADDRESS, ONE_BI, ZERO_BD, ZERO_BI } from './helpers'

export function updateUniswapDayData(event: EthereumEvent): GLXSwapDayData {
  let uniswap = GLXSwapFactory.load(FACTORY_ADDRESS)
  let timestamp = event.block.timestamp.toI32()
  let dayID = timestamp / 86400
  let dayStartTimestamp = dayID * 86400
  let uniswapDayData = GLXSwapDayData.load(dayID.toString())
  if (uniswapDayData === null) {
    uniswapDayData = new GLXSwapDayData(dayID.toString())
  ...
  return uniswapDayData as GLXSwapDayData
}
